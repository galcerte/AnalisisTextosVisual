...
sido el preprocesamiento de los datos, su adecuación para cada representración. Pero una vez tenemos
preparada la información necesaria, los diversos paquetes que hemos introducido han realizado
practicamente todo el trabajo. Aunque también es cierto que representar en un histograma las
palabras más frecuentes, o analizar su sentimiento según diccionarios ya hechos, no es algo quea
...
adicionales sobre variables tipo documento que no utilizaremos para nada en este trabajo. También
...
cuadrada 2x2 que repsente dos oraciones y dos palabras. En la diagonal tendremos los términos
...
Hasta aquí podemos entender el proceso, lo que sigue se escapa demasiado de los objetivos del
trabajo, así que solo esplicaremos qué queremos hacer y no cómo. Hemos visto cómo calcular la
ocurrencia conjunta de las palabras en grupos, pero para establecer relaciones más o menos fuertes
entre las mismas hace falta estudiar la significación de la co-ocurencia. En la referencia [3]
encontramos más información al respecto.
...
sino que tenemos el valor añadido de que el azul y el naranja son colores contrarios en la rueda de
los colores, facilitando así aún más la legibilidad de esta gráfica.
...
posible que este libro sea incluso más negativo que el anterior.
...
Se puede ver, de nuevo, que hay un ligero desbarajuste entre palabras negativas y positivas.
...
más cuando uno se ha leido el libro, uno podría dudar sobre la utilidad práctica de estas técticas
...
tienda de ropa, de informática, una página web, una aplicación... Podríamos aplicar estas técnicas
en definitiva para el análisis de opiniones de cualquier producto o servicio. Cuando tenemos muchas
estas nos podrían ayudar a tener una visión general de la opinión de la gente sin tener que leerlas
todas. Hemos elegido analizar libros porque como ejercicio lo hemos considerado más entretenido.
